...
var questions = [
    ...
    {
        "Who was not the hand of the king?": [
            "Oberyn Martell",
            "Ned Stark",
            "Tyrion Lannister",
            "Ser Davos"
        ...
        "Which tongue is commonly used by the Priests or Priestesses of R'hllor?": [
            ...
            "Dothraki",
            "English",
            "poorly crafted Valyrian"
        ]
    },
    {
        "How many dragons does Daenerys Targaryen mother?": [
            "three",
            "a ton",
            "a million",
            "ten"
    ...
    {
        "Who's the leader of white walkers?": [
            "Night King",
            "Tormund",
    ...
    {
        "What's the name of Arya's Sword?": [
            "Needle",
            "Oath keeper",
            "Widow's wail",
            "Dawn"
...
exports.handler = function (event, context) {
    try {
     ...
     if (event.session.application.applicationId !== "amzn1.ask.skill.8d44f82f-f965-4b58-922c-dd25af5a9b45") {
...
var ANSWER_COUNT = 4;
var GAME_LENGTH = 6;
var CARD_TITLE = "Game of Thrones Trivia"; // Be sure to change this for your skill.

function getWelcomeResponse(callback) {
    var sessionAttributes = {},
        speechOutput = "Welcome to Game of Thrones Trivia. I will ask you " + GAME_LENGTH.toString()
